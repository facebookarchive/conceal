...
The B<X509_V_FLAG_IGNORE_AKID_ISSUER_SERIAL_MISMATCH> flag ignores mismatches
of authority key serial numbers during issuer checks. This enables validation
of legacy certificates with valid authority key identifiers, but malformed
authority key serial numbers.
